This project shows the ability to create a simple webpage with a text form, centering of elements with CSS, creating a header and footer, along with creating proper spacing and formatting with CSS.
